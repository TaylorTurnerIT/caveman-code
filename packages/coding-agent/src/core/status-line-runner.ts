 ...
 *
 * Schema source: see `parseStatusLineSettings` in `@cave/tui`. The command
...
import { parseStatusLineSettings, renderStatusLineDefault, renderStatusLineDetailed, sanitizeOneLine } from "@cave/tui";
